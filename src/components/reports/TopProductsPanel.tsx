    ...
    <VStack align="stretch" spacing={3} width="100%" maxW="600px" mx="auto" mb={6}>
      <Box {...cardStyle} p={4}>
        <Text
          ...
          fontFamily={getFont('body')}
        >
          {t('reports.topProducts.totalInRanking')}
        </Text>
        <Text
          fontSize="xl"
          fontWeight="bold"
        ...
        <Text
          ...
          fontFamily={getFont('body')}
        >
          {t('reports.topProducts.itemsCount', { count: items.length })}
        </Text>
      </Box>
                ...
                <Flex align="flex-start" gap={3}>
                  ...
                  >
                    <Text
                      fontSize="xs"
                      fontWeight="bold"
                      color={rank <= 3 ? 'white' : getColor('text.dashboard.tileTitle')}
                      fontFamily={getFont('body')}
                    >
                      {rank}
                    </Text>
                  ...
                  <Box flex={1} minW={0}>
                    ...
                    >
                      <Text>
                        {t('reports.topProducts.quantity')}: {item.quantity}
                      </Text>
                      <Text>
                        {t('reports.topProducts.shareOfTotal', {
